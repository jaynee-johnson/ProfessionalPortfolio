...
When you change proficiency levels through the ACD users feature, you can change many or all skills assigned to a single user at the same time. If you want to change many or all users assigned to a single skill at once instead, you must do so through the skills feature.
...
5.  In the **Assigned Skills** table, locate the ACD skill you want to modify. In each corresponding row, click the drop-down in the  **Proficiency** field and select the new level you want the user to have.
