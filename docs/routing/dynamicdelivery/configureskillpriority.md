...
**Note**:
This page is specific to a dynamic delivery routing strategy. If your organization uses a static delivery routing strategy, you can [find this information](../staticdelivery/configureskillpriority.md) in the static delivery online help.
