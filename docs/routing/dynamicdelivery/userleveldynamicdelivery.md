...
**Note**: This page is specific to a dynamic delivery routing strategy. If your organization uses a static delivery routing strategy, you can [find this information](../staticdelivery/userlevelstaticdelivery.htm) in the static delivery online help.
...
- [Routing attributes](../routingattributes/routingattributes.htm) limit the pool to agents with certain qualities.